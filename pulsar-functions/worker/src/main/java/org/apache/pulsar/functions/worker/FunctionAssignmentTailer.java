 ...
 * When a worker become a leader, the worker will read to the end of the assignments topic
 * and close its reader to the topic.Then the worker and new leader will be in charge of computing
 * new assignments when necessary. The leader does not need to listen to the assignments topic because it can just
 * update its in memory assignments map directly after it computes a new scheduling.  When a worker loses leadership,
