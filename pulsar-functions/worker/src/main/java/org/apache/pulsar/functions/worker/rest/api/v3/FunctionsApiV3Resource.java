...
public class FunctionsApiV3Resource extends FunctionApiResource {
    ...
    public FunctionStatsImpl getFunctionStats(final @PathParam("tenant") String tenant,
                                              final @PathParam("namespace") String namespace,
                                              final @PathParam("functionName") String functionName) throws IOException {
        return functions().getFunctionStats(tenant, namespace, functionName, uri.getRequestUri(), clientAppId(),
                clientAuthData());
    }
    ...
    public String triggerFunction(final @PathParam("tenant") String tenant,
        ...
        return functions()
                .triggerFunction(tenant, namespace, functionName, input, uploadedInputStream, topic, clientAppId(),
                        clientAuthData());
    }
