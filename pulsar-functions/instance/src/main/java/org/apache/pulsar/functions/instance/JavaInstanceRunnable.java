...
public class JavaInstanceRunnable implements AutoCloseable, Runnable {
    ...
    private void setupInput(ContextImpl contextImpl) throws Exception {
        ...
        if (sourceSpec.getClassName().isEmpty()) {
            ...
            // Use SingleConsumerPulsarSource if possible because it will have higher performance
            // since it is not a push source that require messages to be put into an immediate queue
