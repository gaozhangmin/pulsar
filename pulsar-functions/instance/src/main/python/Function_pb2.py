...
_CONSUMERSPEC = _descriptor.Descriptor(
    ...
    nested_types=[_CONSUMERSPEC_RECEIVERQUEUESIZE, _CONSUMERSPEC_SCHEMAPROPERTIESENTRY,
...
SourceSpec = _reflection.GeneratedProtocolMessageType('SourceSpec', (_message.Message,), {
    ...
    'TopicsToSerDeClassNameEntry': _reflection.GeneratedProtocolMessageType('TopicsToSerDeClassNameEntry',
                                                                            (_message.Message,), {
